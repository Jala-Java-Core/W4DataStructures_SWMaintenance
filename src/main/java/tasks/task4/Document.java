...
public class Document {
    ...
    public String getCity() { return publishingLocation.getCity(); }

    public String getState() { return publishingLocation.getState(); }

    public String getPostCode() { return publishingLocation.getPostCode(); }

    public boolean sameAuthor(Document document){
        return getAuthor().equals(document.getAuthor());
    }

    public int compareDates(Document document){
        return getDate().compareTo(document.getDate());
    }
